...
/*
 * Macros for source level debugging.
 * Source: https://github.com/adamw/scala-macro-debug
 */
trait DebugConsole {
  /**
   * Prints debug information in a multi-line format. If the debugging is
   ...
   * parameter is a constant, it will be used as a title. All the other
